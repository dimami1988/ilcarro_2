                ...
                <div className="footer_redline">
                    ...
                    <div className="footer_text2 ">
                        <p>Candy canes topping dessert jelly beans pie jelly beans sweet roll. Toffee
                            ...
                            cookie gingerbread. Icing wafer pie pudding ice cream bonbon halvah bonbon topping.
                            Donut halvah tiramisu bear claw tart.
                        </p>
                    </div>
                    <div className="footer_text3">
                        <p>Affordable prices Guaranteed cars</p>
